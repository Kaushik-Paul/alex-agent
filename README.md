...
> ⚠️ **Warning**
> This project is for research and educational purposes only. It does **not** provide financial, investment, tax, or legal advice. Any outputs, charts, or recommendations generated by this project are **experimental** and must **not** be used as the sole basis for real-world financial decisions.
>
> By using this project, you agree that you are solely responsible for your own investment decisions. The project owner(s), maintainer(s), and contributor(s) are **not liable** for any financial loss, damages, or other consequences arising from the use of this software. Always conduct your own independent research and, where appropriate, consult a qualified financial professional before making investment decisions.
